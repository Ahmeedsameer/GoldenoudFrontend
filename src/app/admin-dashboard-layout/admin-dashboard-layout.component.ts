  ...
  navItems: NavItem[] = [
    {
      ...
      subItems: [
        { name: "حسابات الأدمن", path: "/dashboard/users/" },
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "إدارة الأسعار", path: "/dashboard/pricing" },
...

    {
      ...
      name: "المخزون",
      subItems: [
        { name: "لوحة المخزون", path: "/dashboard/inventory-dashboard" },
        { name: "المخزون والتوريدات", path: "/dashboard/stock" },
      ],
    },

    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 7l4 4-4 4M3 11h18"/><path d="M7 21l-4-4 4-4"/></svg>`,
      name: "عمليات الفروع",
      subItems: [
        { name: "لوحة العمليات الإدارية", path: "/dashboard/branch-operations/logistics-dashboard" },
...

    {
      ...
      name: "التقارير",
      subItems: [
        { name: "نظرة عامة",        path: "/dashboard/reports" },
        ...
        { name: "استهلاك الزيوت والزجاجات", path: "/dashboard/reports/perfume-consumption" },
        { name: "مقارنة الفروع",     path: "/dashboard/reports/branch-comparison" },
        ...
        { name: "تقرير حركة المخزون", path: "/dashboard/reports/stock-movement" },
...

    {
      ...
      name: "الإعدادات",
      subItems: [
        { name: "بيانات الشركة", path: "/dashboard/settings/company" },
      ],
    },
