  ...
  groups: ReportGroup[] = [
    ...
    },
    {
      ...
      cards: [
        ...
        { title: 'الربح حسب الدفعة', description: 'أعلى الدُفعات ربحاً — من لقطات الفاتورة المجمّدة، وليس من أسعار حية', path: '/dashboard/reports/batches/profit', icon: '📈' },
        { title: 'المبيعات حسب الدفعة', description: 'أعلى الدُفعات مبيعاً — الكمية المباعة الفعلية من كل دفعة', path: '/dashboard/reports/batches/sales', icon: '🛒' },
        { title: 'سجل حركة الدفعات', description: 'كل حركة شراء/بيع/نقل/هالك/تسوية على مستوى الدفعة الواحدة', path: '/dashboard/reports/batches/movements', icon: '🔄' },
