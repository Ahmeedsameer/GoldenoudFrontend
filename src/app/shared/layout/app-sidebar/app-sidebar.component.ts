...
export class AppSidebarComponent {
  ...
  // Manager-only nav items (single safe link)
  ...
  demoItems: NavItem[] = [
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M19 21V5C19 3.89543 18.1046 3 17 3H7C5.89543 3 5 3.89543 5 5V21M9 21V9H15V21M17 21H7V5H17V21ZM7 3C7 1.89543 7.89543 1 9 1H15C16.1046 1 17 1.89543 17 3" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`,
      name: "الفروع",
      path: "/demo",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M3 3H21V21H3V3ZM9 9H15V15H9V9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>`,
      name: "لوحة التحكم",
      path: "/demo/dashboard/1",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 4H20V20H4V4ZM6 6V18H18V6H6ZM8 8H16V10H8V8ZM8 12H16V14H8V12Z" stroke="currentColor" stroke-width="2"/></svg>`,
      name: "الفواتير",
      path: "/demo/invoices/1",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C14 2 16 4 16 6C16 8 14 10 12 10C10 10 8 8 8 6C8 4 10 2 12 2ZM12 12C8 12 4 16 4 20H20C20 16 16 12 12 12ZM18 20H6V22H18V20Z" stroke="currentColor" stroke-width="2"/></svg>`,
      name: "الموظفين",
      path: "/demo/workers/1",
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M4 4H20V20H4V4ZM4 9H20V4H4V9ZM4 14H20V9H4V14ZM4 20H20V14H4V20ZM9 16H15V18H9V16Z" stroke="currentColor" stroke-width="2"/></svg>`,
      name: "التقارير",
      path: "/demo/analytics/1",
    },
  ];
  ...
  /** Resolved once on init and kept in sync via user$ subscription */
  isManagerUser = false;
  ...
  ngOnInit() {
    // Resolve role immediately
    this.isManagerUser = this.authService.isManager();

    // Keep in sync if the user changes (login / logout)
